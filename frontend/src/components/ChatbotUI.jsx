...
//       <div style={styles.sidebar}>
//         <h4 style={styles.heading}>Categories</h4>
//         <button style={styles.btn}>BC Welfare</button>
//         <button style={styles.btn}>SC Welfare</button>
//         <button style={styles.btn}>ST Welfare</button>
//         <button style={styles.btn}>Minority</button>
//       </div>
